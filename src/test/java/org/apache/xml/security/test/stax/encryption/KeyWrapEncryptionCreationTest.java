...
public class KeyWrapEncryptionCreationTest {
    ...
    public void testAES128KW() throws Exception {
        ...
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmlenc#kw-aes128";
        ...
        final Document doc = decryptUsingDOM(document, keyWrappingKey);
    ...
    public void testAES192KW() throws Exception {
        ...
        keygen.init(192);
        final SecretKey keyWrappingKey = keygen.generateKey();
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmlenc#kw-aes192";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
    ...
    public void testAES256KW() throws Exception {
        ...
        keygen.init(256);
        final SecretKey keyWrappingKey = keygen.generateKey();
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmlenc#kw-aes256";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
    ...
    public void testTripleDESKW() throws Exception {
        ...
        final SecretKey keyWrappingKey = keygen.generateKey();
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmlenc#kw-tripledes";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
    ...
    public void testRSAv15KW() throws Exception {
        ...
        // Set up the Key Wrapping Key
        final Key keyWrappingKey = rsaKeyPair.getPublic();
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmlenc#rsa-1_5";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
        ...
        // Decrypt using DOM API
        final Document doc = decryptUsingDOM(document, rsaKeyPair.getPrivate());
    ...
    public void testRSAOAEPKW() throws Exception {
        ...
        // Set up the Key Wrapping Key
        final Key keyWrappingKey = rsaKeyPair.getPublic();
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmlenc#rsa-oaep-mgf1p";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
    ...
    public void testRSAOAEP11KW() throws Exception {
        ...
        // Set up the Key Wrapping Key
        final Key keyWrappingKey = rsaKeyPair.getPublic();
        final String wrappingAlgorithm = "http://www.w3.org/2009/xmlenc11#rsa-oaep";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
    ...
    public void testCamellia128KW() throws Exception {
        ...
        keygen.init(128);
        final SecretKey keyWrappingKey = keygen.generateKey();
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmldsig-more#kw-camellia128";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
    ...
    public void testCamellia192KW() throws Exception {
        ...
        keygen.init(192);
        final SecretKey keyWrappingKey = keygen.generateKey();
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmldsig-more#kw-camellia192";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
    ...
    public void testCamellia256KW() throws Exception {
        ...
        keygen.init(256);
        final SecretKey keyWrappingKey = keygen.generateKey();
        final String wrappingAlgorithm = "http://www.w3.org/2001/04/xmldsig-more#kw-camellia256";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
    ...
    public void testSEED128KW() throws Exception {
        ...
        keygen.init(128);
        final SecretKey keyWrappingKey = keygen.generateKey();
        final String wrappingAlgorithm = "http://www.w3.org/2007/05/xmldsig-more#kw-seed128";
        properties.setEncryptionKeyTransportAlgorithm(wrappingAlgorithm);
        properties.setEncryptionTransportKey(keyWrappingKey);
