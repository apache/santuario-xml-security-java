...
public class EDDSASignatureTest {
    ...
    private static final String EDDSA_KS =
        "src/test/resources/org/apache/xml/security/samples/input/eddsa.p12";
    private static final String EDDSA_KS_PASSWORD = "security";
    private static final String EDDSA_KS_TYPE = "PKCS12";
    public static boolean bcAddedForTheTest=false;
    ...
    public void testEd22519() throws Exception {
        ...
        keyStore.load(new FileInputStream(EDDSA_KS), EDDSA_KS_PASSWORD.toCharArray());
