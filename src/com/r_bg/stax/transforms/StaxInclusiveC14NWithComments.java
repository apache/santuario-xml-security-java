...
/**
 * Stax-based implementation of Inclusive C14N WithComments TransformService
 *
 * @author Sean Mullan
 */
public class StaxInclusiveC14NWithComments extends TransformService {
	...
	throws TransformException {
        ...
        if (c14n == null) {
            c14n = new C14n(new AttributeHandleExclusive(), os, true);
        }
        c14n.accept(reader);
        return null;
    }
