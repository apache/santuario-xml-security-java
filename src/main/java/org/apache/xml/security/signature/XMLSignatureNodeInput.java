...
/**
 * The XMLSignature Input wrapping a {@link Node}
 */
public class XMLSignatureNodeInput extends XMLSignatureInput {

    /**
     * Construct a XMLSignatureInput from a subtree rooted by rootNode.
     * This method included the node and <I>all</I> its descendants in the output.
     *
     * @param rootNode
     */
    public XMLSignatureNodeInput(Node rootNode) {
        super(rootNode);
    }
